...
#ifndef SUPER_DOSA_SEARCH_SWIFT_H
#define SUPER_DOSA_SEARCH_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="super_dosa_search",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC17super_dosa_search11AppDelegate")
...
SWIFT_CLASS("_TtC17super_dosa_search17MainFlutterWindow")
